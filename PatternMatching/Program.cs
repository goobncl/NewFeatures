...
namespace PatternMatching
{
    class Program
    {
        ...
        {
            var rects = new Rectangle { Height = 10, Width = 0 };
            ...
            rectangle.Width = 12;
            rectangle.Height = 8;
            Console.WriteLine($"Area of Rectangle : {GetAreaOfShape(rectangle)}");

            Product product = new Product { Category = "Shirt", Name = "Blue Formal Shirt", Quantity = 10, UnitPrice = 200.00F };
            Console.WriteLine($"Price of Discount : {GetProductDiscount(product)}");
        }
